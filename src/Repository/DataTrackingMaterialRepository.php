...
class DataTrackingMaterialRepository extends EntityRepository
{
     ...
     * @return float
     */
    public function TotalQuantity($data_tracking_id = '', $material_id = '', $fecha_inicial = '', $fecha_fin = '')
    {
        $em = $this->getEntityManager();
        $consulta = 'SELECT SUM(d_t_m.quantity) FROM App\Entity\DataTrackingMaterial d_t_m ';
        $join = ' LEFT JOIN d_t_m.dataTracking d_t LEFT JOIN d_t_m.material m ';
        $where = '';
     ...
     * @return float
     */
    public function TotalMaterials($data_tracking_id = '', $material_id = '', $project_id = '', $fecha_inicial = '', $fecha_fin = '')
    {
        $em = $this->getEntityManager();
