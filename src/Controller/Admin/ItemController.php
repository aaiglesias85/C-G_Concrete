...
class ItemController extends AbstractController
{
    ...
    public function salvar(Request $request)
    {
        ...
        try {
            ...
            if ($item_id == "") {
                $resultado = $this->itemService->SalvarItem($unit_id, $description, $price, $status);
            } else {
                $resultado = $this->itemService->ActualizarItem($item_id, $unit_id, $description, $price, $status);
            }
