...
class ProjectService extends Base
{
     ...
     * @author Marcel
     */
    public function ActualizarProject($project_id, $contractor_id, $inspector_id, $number, $name, $location, $po_number, $po_cg)
    {
        $em = $this->getDoctrine()->getManager();
     ...
     * @author Marcel
     */
    public function SalvarProject($contractor_id, $inspector_id, $number, $name, $location, $po_number, $po_cg)
    {
        $em = $this->getDoctrine()->getManager();
    ...
    public function ListarProjects($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0, $contractor_id, $inspector_id)
    {
        ...
        $lista = $this->getDoctrine()->getRepository(Project::class)
            ->ListarProjects($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0, $contractor_id, $inspector_id);
    ...
    public function TotalProjects($sSearch, $contractor_id, $inspector_id)
    {
        $total = $this->getDoctrine()->getRepository(Project::class)
            ->TotalProjects($sSearch, $contractor_id, $inspector_id);
